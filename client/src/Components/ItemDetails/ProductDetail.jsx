    ...
    return (
        <>
            ...
            <SmallText>
                ...
                <Typography><StyledBadge />Purchase this Furniture or Appliance and Get Extra GHS500 Off on Select ACs</Typography>
                <Typography><StyledBadge />Partner OfferExtra 10% off upto GHS500 on next furniture purchase</Typography>
            </SmallText>
            <Table>
                <TableBody>
                    <ColumnText>
                        <TableCell style={{ color: '#878787' }}>Delivery</TableCell>
                        <TableCell style={{ fontWeight: 600 }}>Delivery by {date.toDateString()} | GHS40</TableCell>
                    </ColumnText>
                    <ColumnText>
                    ...
                    <ColumnText>
                        ...
                        <TableCell>
                            ...
                            <Typography>View more sellers starting from GHS329</Typography>
                        </TableCell>
                    </ColumnText>
                    <TableRow>
                        <TableCell colSpan={2}>
